              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final created_at = created_at_str != null
                        ? DateTime.tryParse(created_at_str)
                        : null;
                    final formattedDate = created_at != null
                        ? DateFormat('HH-MM a   dd-MM-yyyy').format(created_at)
                        : '';
                    // لتمييز لون الاشعارات غير المقروءة
                    Color cardColor = item['read_at'] == null
                        ? const Color.fromARGB(255, 237, 238, 239)
                        : Colors.white;
                    return Card(
