...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(json['name'], json['profile_image']);
  }
}
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width: AnnPublishers.length *
                                          (circleSize - overlap) +
                                      overlap,
                                  height: circleSize,
                                  child: Stack(
                                      children: List.generate(
                                          AnnPublishers.length, (index) {
                                    double leftPos =
                                        index * (circleSize - overlap);
                                    User user = AnnPublishers[index];
                                    final hasImage = user.img != null &&
                                        user.img!.isNotEmpty;
                                    return Positioned(
                                        left: leftPos,
                                        child: CircleAvatar(
